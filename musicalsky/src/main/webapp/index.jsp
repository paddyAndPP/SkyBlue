	...
	<TBODY>
		...
		<TR style="HEIGHT: 254px">
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				<TBODY>
					<TR>
						<TD style="HEIGHT: 45px"><INPUT type="text" class=input value="${adminL.loginAccount }" name="loginAccount" id="loginAccount"></TD>
					</TR>
					<TR>
						<TD><INPUT type="password" class=input value="${adminL.loginPassword }" name="loginPassword" id="loginPassword"/></TD>
					</TR>
					<TR>
						<td>
							<select id="loginRole" name="loginRole" class="input" style="margin-top: 15px;height: 24px">
								<option value="">请选择用户类型...</option>
								<option value="0"  ${'0'==adminL.loginRole?'selected':'' }>超级管理员</option>
								<option value="1"  ${'1'==adminL.loginRole?'selected':'' }>普通管理员</option>
								<option value="2"  ${'2'==adminL.loginRole?'selected':'' }>教师</option>
							</select>
						</td>
					</TR>
				</TBODY>
